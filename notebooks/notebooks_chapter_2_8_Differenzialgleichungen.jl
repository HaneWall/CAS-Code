...
# ╔═╡ d4333fc2-25b8-11ee-036d-477e12504a8d
md"""
# Differenzialgleichungen
"""

# ╔═╡ acec5a0e-e488-4c5f-9cf4-84a2a5eb24df
md"""
## *Euler*-Vorwärts Methode
"""

# ╔═╡ 50cfd5c2-55a3-48a0-b265-743d13c83b84
function euler_forward(t₀::Real, t₁::Real, x₀::Real, f::Function, Δt::Real)
	x_new = x₀
	t_new = t₀
	sol_t = Float64[t₀]
	sol_x = Float64[x₀]
	...
	return hcat(sol_t, sol_x)
end

# ╔═╡ dfd77adb-6519-4206-8c44-7d74707a0974
md"""
Man sollte vorsichtig mit der Schrittweitengröße sein!
"""

# ╔═╡ 5cd5bf1c-9a3d-4e73-b475-eec879398836
let
f(x) = 2*x
g(x) = -3*x

sol_1 = euler_forward(0., 5., 1., f, 0.1)
sol_2 = euler_forward(0., 10., 1., g, 0.1)
sol_3 = euler_forward(0., 10., 1., g, 0.5)
sol_4 = euler_forward(0., 10., 1., g, 1.)

	
CairoMakie.activate!(type= "svg")
fig = Figure(resolution= (800, 600))
ax_tl = Axis(fig[1, 1], xlabel=L"t", ylabel=L"x")
ax_tr = Axis(fig[1, 2], xlabel=L"t", ylabel=L"x")
ax_bl = Axis(fig[2, 1], xlabel=L"t", ylabel=L"x")
ax_br = Axis(fig[2, 2], xlabel=L"t", ylabel=L"x")
...
# ╔═╡ 5d8b38c1-edfb-4a91-ba43-e5f7f88dc063


# ╔═╡ 0dc350cc-d356-4f34-b304-a101ffb92201
md"""
## Appendix
"""

# ╔═╡ ec8065d6-8c57-425c-b59a-550805710b22
using CairoMakie, DifferentialEquations, PlutoUI

# ╔═╡ db3cbbd3-7bff-4e17-9dcf-a0d6324a4009
TableOfContents()
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "766f5ececbe78137d42f9400ccc80df439db07da"
...
git-tree-sha1 = "e0da03c52673bc0ab5138d1381b4dbc48ea343b9"
...
git-tree-sha1 = "1709c408c2e79073c0a69029a00f633d21e559cf"
...
git-tree-sha1 = "a6e75a4ec749d16ba54ab49d925dfdd5b4cc5393"
...
git-tree-sha1 = "d4005f0ada4442c0cd7a63705d6043b442d41990"

...
# ╔═╡ 021054ce-02bf-11ee-169e-837c01c4f253
md"""
# Integration: Umkehrung der Differenziation und Flächen unter Kurven
"""

# ╔═╡ 7aae7fc6-9927-448a-bd5b-a5819013e92b
md"""
## Symbolische Integration
"""

# ╔═╡ abbab351-88f3-4670-b835-4f28d16c04fd
md"""
Für die symbolische Integration nutzen wir die Packages Symbolics.jl sowie die Erweiterung SymbolicNumericIntegration.jl.
"""

# ╔═╡ 0d7f7e1d-3582-4dda-aa2f-96ae1fe97b1a


# ╔═╡ 51235102-6710-41ec-99ff-c5a8f3eff315
let
	@variables x 
	f = x^2 + 4 
	integrate(f)
...
# ╔═╡ 52ea3aac-a508-44b5-8ed1-91c74a0309e2
md"""
Symbolische Integration mit Integrationsgrenzen wird derzeit nicht untestützt.
"""

# ╔═╡ 544b9bc1-136e-49d7-ad2a-b04ac19dd19c
md"""
## Numerische Integration
"""

# ╔═╡ 08a2852f-290f-44fd-ab6d-a18151fc0dbe
let 
function riemann(f::Function, a, b, n)
	#stepsize
	h = (b-a)/n
	res = sum(f.(a .+ h .* (0:n-1))) .* h
	return res
end

function trapezregel(f::Function, a, b, n)
	#stepsize
	h = (b-a)/n
	#boundary points
	s = f(a) + f(b)
...
f(x) = exp(x)
println("Riemann:", riemann(f, 0, 1, 100))
println("Trapez:", trapezregel(f, 0, 1, 100))
end

# ╔═╡ 0a267305-e4cb-4059-a959-fc3a289630cc
md"""
## Appendix
"""

# ╔═╡ 86358dee-3e43-4fbb-b978-66db7bdb3ef3
using Symbolics, SymbolicNumericIntegration, PlutoUI

# ╔═╡ a93df3b9-459d-49da-a166-40756f1afa00
TableOfContents()
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "3fc0737c2d202ba56e74e409c153826e18752a62"
